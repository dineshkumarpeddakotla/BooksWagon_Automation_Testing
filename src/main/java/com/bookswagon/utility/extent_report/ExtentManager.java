 ...
 * @since 31-07-2021
 */
package com.bookswagon.utility.extent_report;
...
public class ExtentManager {
    ...
    private static final String reportFileName = "BooksWagon_Testing_Report" + ".html";
    ...
    public static ExtentReports createInstance() {
        ...
        extent.setSystemInfo("AUT", "BooksWagon");
